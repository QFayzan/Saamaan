        ...
        @if(auth()->user()->type == "driver" )
            ...
            @if(auth()->user()->driver->verified)
                <div class="container-fluid mb-5">
                    ...
                    <a class="btn btn-block py-4 dashboard-btn btn-primary" href="{{route('orders.index')}}">
                ...
                <div class="container-fluid mb-5">
                    ...
                    <a href="{{route('drivers.previous')}}" class="btn btn-info btn-block py-4 dashboard-btn">
