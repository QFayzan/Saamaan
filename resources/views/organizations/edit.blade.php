                        ...
                        <form method="POST" action="{{ route('organizations.update',$organization->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="name" type="text" name="name"
                                       ...
                                       value="{{ $organization->name }}" placeholder="Name">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input id="address" type="text" name="address"
                                       ...
                                       value="{{ $organization->address }}" placeholder="Address">
                            ...
                            <div class="form-group">
                                ...
                                <input id="contact" type="text" name="contact"
                                       ...
                                       value="{{ $organization->contact }}" placeholder="Contact">
                            ...
                            <div class="form-group">
                                ...
                                <input id="registration" type="text" name="registration"
                                       ...
                                       value="{{ $organization->registration }}" placeholder="Registration">
